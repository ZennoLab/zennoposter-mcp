...
Сам контракт несёт семантическую версию, сейчас `1.3.0`. Она приходит в `info.version` документа OpenAPI и в поле `version` ответа `GET /capabilities`.
...
<!-- translated-from: versioning-and-deprecation.md 5f0df2d6cbca477a09e10ef3e77d38578bdf8bbb -->
