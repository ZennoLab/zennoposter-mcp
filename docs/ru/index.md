...
Этот сайт описывает ZennoPoster **7.9.2 и новее** и ZennoDroid **2.6.1 и новее**, версию контракта **1.3.0**, MCP-серверы **0.4.0** (MCP.ProjectMaker, MCP.ZennoPoster, MCP.Android) и **0.2.0** (MCP.Instance). Какой сервер к какому продукту и как узнать версии у своей установки — в [compatibility.md](compatibility.md).
...
<!-- translated-from: index.md aeabdebeb88b62087c7812ecc862bc53f50e55e4 -->
